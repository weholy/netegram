...
private final class NetegramSettingsIconCache {
    ...
    func image(key: String, generate: () -> UIImage?) -> UIImage? {
        self.lock.lock()
        defer { self.lock.unlock() }
        if let existing = self.images[key] {
            return existing
        }
        guard let generated = generate() else {
            return nil
        }
...
public struct PresentationResourcesSettings {
    ...
    public static var savedMessages: UIImage? { return netegramSettingsIcon(custom: "SavedMessages", name: "Item List/Icons/SavedMessages", backgroundColors: [colorBlue]) }
    public static var recentCalls: UIImage? { return netegramSettingsIcon(custom: "RecentCalls", name: "Item List/Icons/Phone", backgroundColors: [colorGreen]) }
    public static var devices: UIImage? { return netegramSettingsIcon(custom: "Devices", name: "Item List/Icons/Devices", backgroundColors: [colorOrange]) }
    public static var chatFolders: UIImage? { return netegramSettingsIcon(custom: "ChatFolders", name: "Item List/Icons/Folder", backgroundColors: [colorLightBlue]) }
    public static let stickers = renderSettingsIcon(name: "Item List/Icons/Sticker", backgroundColors: [colorOrange])
    public static var notifications: UIImage? { return netegramSettingsIcon(custom: "Notifications", name: "Item List/Icons/Notifications", backgroundColors: [colorRed]) }
    public static var security: UIImage? { return netegramSettingsIcon(custom: "Privacy", name: "Item List/Icons/Privacy", backgroundColors: [colorGray]) }
    public static var dataAndStorage: UIImage? { return netegramSettingsIcon(custom: "DataAndStorage", name: "Item List/Icons/Data", backgroundColors: [colorGreen]) }
    public static var appearance: UIImage? { return netegramSettingsIcon(custom: "Appearance", name: "Item List/Icons/Appearance", backgroundColors: [colorLightBlue]) }
    public static var language: UIImage? { return netegramSettingsIcon(custom: "Language", name: "Item List/Icons/Language", backgroundColors: [colorPurple]) }
    public static var powerSaving: UIImage? { return netegramSettingsIcon(custom: "PowerSaving", name: "Item List/Icons/PowerSaving", backgroundColors: [colorOrange]) }
    ...
    public static var myProfile: UIImage? { return netegramSettingsIcon(custom: "Profile", name: "Item List/Icons/Profile", backgroundColors: [colorRed]) }
    public static let netegram = renderSettingsIcon(name: "Item List/Icons/Netegram", backgroundColors: [colorBlue])
    ...
    public static var ton: UIImage? { return netegramSettingsIcon(custom: "Wallet", name: "Item List/Icons/Gram", backgroundColors: [colorBlue]) }
